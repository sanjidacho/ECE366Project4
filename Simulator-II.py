    ...
    while PC < len(instructionMemory):
        ...
        if opcode == 0:
            ...
            # Slt instruction
                ...
                fourCyclesInstructions += 1
                if rd != 0:
                    registers[rd] = int(registers[rs] < registers)
                else:
                    print "Zero register can't be updated"
        ...
        # opcode is not zero then I type instruction
            ...
            if opcode == 8:
                ...
                print "PC:",PC,"Addi","$"+str(rs)+", $"+str(rt)+",",imm
            ...
            # Lw instruction
                ...
                print "PC:",PC,"Lw","$"+str(rt)+",",str(imm-8192)+"($"+str(rs)+")"
            ...
            # Sw instruction
                ...
                print "PC:",PC,"Sw","$"+str(rt)+",",str(imm-8192)+"($"+str(rs)+")"
                totalCycles += 4
                totalPipelinedCycles += 1
                fourCyclesInstructions += 1
                # since dataMemory starts from 0x2000 = 8192 in decimal, subtract from address 8192
